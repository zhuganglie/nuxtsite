...
美国教育心理学家加涅<a href="https://en.wikipedia.org/wiki/Robert_M._Gagn%C3%A9"  target="_blank">（Robert Gagne）</a>提出了一个教学设计模型。根据这个模型，一个完整的教学过程应包含以下九个环节。
...
<caption class="font-bold text-xl mb-4">教学环节与学习过程</caption>
  <tr>
    <th>步骤</th>
    <th>教学环节</th>
    <th>学习过程</th>
