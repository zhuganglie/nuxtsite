...
<template>
  <div class="z-999 bg-zinc-100 top-0 sticky w-full container">
     <nav class=" px-8 py-6 flex justify-between">

    <router-link to="/" class=" text-xl font-bold md:text-2xl no-underline">ST</router-link>
   
      <div :class="showMenu ? 'flex flex-col' : 'hidden'" class=" list-none mt-8 space-y-4  md:space-y-0 md:flex md:items-center md:space-x-10 md:m-0">
